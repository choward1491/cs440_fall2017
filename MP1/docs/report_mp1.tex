...
\begin{align*}
h_{ch}(p) = \sum_{(x,y) \in \hat{E}_{ch}} d_{ch}(x,y, \beta) + |V_I|
\end{align*}
...
\begin{table}[ht]
   ...
   \hline
   \end{tabular}
   \caption{Solution Path Cost - A* with $h_{ch}(p)$} \label{tab:sol12}
   \end{table}
   ...
   \hline
    Tiny Search & Small Search & Medium Search\\
    \hline \hline 
   2014 & 9,255,960 &  500,000,000\\
   \hline
   \end{tabular}
   \caption{Number of Nodes Expanded - A* with $h_{ch}(p)$} \label{tab:nnode12}
   \end{table}
   ...
   \begin{align*}
   h_{fch}(p) &= \left(1 + \beta_1 \right) \left( \sum_{ (x,y) \in E_{ch} } |x - y|_2 - \max_{ (x,y) \in E_{ch} } |x - y|_2 \right) + \beta_2 |V_I|
   \end{align*}
...
\begin{table}[ht]
   ...
   \hline
   \end{tabular}
   \caption{Solution Path Cost - A* with $h_{fch}(p)$} \label{tab:solfch}
   \end{table}
   ...
   \hline
   \end{tabular}
   \caption{Number of Nodes Expanded - A* with $h_{fch}(p)$} \label{tab:nnodefch}
   \end{table}   
