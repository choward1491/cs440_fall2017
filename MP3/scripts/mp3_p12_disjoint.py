# This script is to handle work being done for MP3 Problem 1.1 for disjoint features
...
for dim in dims:
    ...
    def feature_functor(X,L):
        return myfeat.disjoint_patches(X,L,dims=dim,nvals=2)
